...
if (the_Foundation_DIR OR
    ...
    if (ENABLE_CLASSICNET)
        # Phase 1 seam: the_Foundation's iSocket I/O is driven by a ClassicNet
        # CNTransport instead of a raw fd. The classicnet lib is linked below in
        # cmake/ClassicNet.cmake once its target exists.
        set (TFDN_CLASSICNET ON CACHE BOOL "" FORCE)
    endif ()
